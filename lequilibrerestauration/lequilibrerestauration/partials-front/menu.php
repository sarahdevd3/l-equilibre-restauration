...
<head>
    ...
    <title>L'équilibre-Restauration</title>
        ...
        <div class="container">
            ...
            <div class="menu text-right">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo SITEURL; ?>index.php">Accueil</a>
                    </li>
                    <li>
                        <a href="<?php echo SITEURL; ?>history.php">Notre histoire</a>
                    </li>
                    <li>
                        <a href="<?php echo SITEURL; ?>categories.php">Menu</a>
                    </li>
                    <li>
                        <a href="<?php echo SITEURL; ?>order.php">Commander</a>
                    </li>
